<?php
    ...
    $result = mysqli_query($conn, "select clave,descripcion,lote,piezas,caducidad from medicamento inner join anaquel on medicamento.clave = anaquel.clave_medicamento order by clave asc");
