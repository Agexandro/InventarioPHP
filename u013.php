...
<body>
    ...
    <div class="container">
        <div class="columns">
            ...
            <div class="column ">
                <?php include_once("data/inventario_u013.php"); ?>
            </div>
        </div>
    </div>
    <!-- Modal Eliminación -->
    <div class="mod" id="modal">
        <div class="modal-box">
            ...
            <form action="data/delete.php" method="POST" style="text-align: center;">
                ...
                <button name="btn_del_u013" type="submit" class="button is-danger">Si, eliminar</button>
    ...
    <div class="mod" id="modal_update">
        <div class="modal-box">
            ...
            $idform = "submit_u013_update";
            $_clave = "clave_update";
            $_lote = "lote_update";
            $_piezas = "piezas_update";
            $_cad = "cad_update";
            $button = "validar_u013_update()";
...
mysqli_close($conn);
$v = new DateTime("10-01-2021");
//echo date_format($v,"y/m/d");
?>